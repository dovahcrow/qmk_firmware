...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        OPWD  , KC_Z , KC_X , KC_C          , KC_V         , KC_B         , CW_TOGG   ,         OPWD , KC_N         , KC_M         , KC_COMM      , KC_DOT, KC_SLSH , OPWD,
    ...
    [1] = LAYOUT(
        ...
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,         UG_TOGG, UG_NEXT, KC_NO    , KC_NO    , UG_PREV, KC_NO, KC_NO,
    ...
    [2] = LAYOUT(
        ...
        KC_NO  , KC_G1, KC_G2, KC_G3, KC_G4, KC_G5, KC_NO,         KC_NO, KC_HOME   , KC_PGDN  , KC_PGUP, KC_END , TMUXC, KC_NO,
    ...
    [3] = LAYOUT(
        ...
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,         KC_NO, MS_WHLR, MS_WHLU, MS_WHLD, MS_WHLL, KC_NO, KC_NO,
    ...
    [4] = LAYOUT(
        ...
        KC_NO, KC_SCLN, KC_4, KC_5  , KC_6, KC_EQL , KC_NO,         KC_NO, KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, KC_NO, KC_NO,
        KC_NO, KC_GRV , KC_7, KC_8  , KC_9, KC_BSLS, KC_NO,         KC_NO, KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO, KC_NO,
        NDEF , NDEF   , NDEF, KC_DOT, KC_0, KC_MINS, NDEF ,         NDEF , KC_NO  , KC_NO  , KC_NO  , NDEF   , NDEF , NDEF
    ),
    // SYM
    [5] = LAYOUT(
        KC_LALT, KC_LCBR, KC_EXLM, KC_AT  , KC_HASH, KC_RCBR, NDEF ,         NDEF , KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
...
const uint16_t PROGMEM combo_df[] = {MOD_D, MOD_F, COMBO_END};
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [0] = { ENCODER_CCW_CW(C(S(KC_TAB)), C(KC_TAB)),  ENCODER_CCW_CW(KC_LEFT, KC_RGHT)  },
