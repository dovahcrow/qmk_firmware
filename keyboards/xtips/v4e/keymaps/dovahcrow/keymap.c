...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [4] = LAYOUT(
        ...
        KC_NO, KC_GRV , KC_7, KC_8  , KC_9, KC_BSLS, KC_NO,         KC_NO, KC_NO, KC_7 , KC_8, KC_9, KC_NO, KC_NO,
    ...
    [5] = LAYOUT(
        ...
        KC_NO  , KC_TILD, KC_AMPR, KC_ASTR, KC_LPRN, KC_PIPE, KC_NO,         KC_NO, KC_TILD, KC_AMPR, KC_ASTR, KC_LPRN, KC_PIPE, KC_NO,
